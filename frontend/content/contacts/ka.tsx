...
export default function ContactsContentKa() {
  return (
    <>
      <section className="mx-auto max-w-[1100px] px-6 pt-16 pb-10 text-center md:pt-20 md:pb-12">
        ...
        <p className="mx-auto mt-5 max-w-[640px] text-base leading-relaxed text-[var(--ink)] md:text-lg">
          ჩვენ არ გვაქვს სერვისი მუდმივად დასაჯდომად ან ვიტრინა დესერტებით, მაგრამ მოგიწვევთ შეკვეთის
          Pickup-ზე.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-14 md:py-20">
        <div className="grid gap-12 text-center sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 xl:grid-cols-6">
          <InfoColumn icon={<Clock strokeWidth={1.4} className="h-12 w-12" />} title="დღე–დღეში">
            <p>
              <span className="font-semibold">მაღაზიის საათები:</span> 11:00–21:00
            </p>
            <p>
              <span className="font-semibold">მენეჯერი:</span> 11:00–21:00
            </p>
          </InfoColumn>

          <InfoColumn icon={<MapPin strokeWidth={1.4} className="h-12 w-12" />} title="მისამართი">
