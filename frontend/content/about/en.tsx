...
export default function AboutContentEn() {
  return (
    <>
      <h1 className="text-2xl font-bold tracking-[0.06em] uppercase md:text-3xl">About us</h1>
      <div className="mt-8 space-y-6 text-base leading-relaxed md:text-lg">
        <p>
          ...
          {SITE_INFO.address.city}, {SITE_INFO.address.country}. We focus on quality ingredients,
          reliable fulfilment times, and clear communication for pickup and delivery.
        </p>
        ...
        <p>
          Pickup address: {SITE_INFO.address.line1}, {SITE_INFO.address.city}, {SITE_INFO.address.country}.
          Prices on the site are shown in {SITE_INFO.currency}.
        </p>
      </div>
    </>
  );
