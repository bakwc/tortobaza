...
>(({ className, children, hideClose, ...props }, ref) => {
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 w-[min(1100px,calc(100vw-1.5rem))] max-h-[calc(100vh-1.5rem)] overflow-hidden rounded-3xl bg-white shadow-2xl",
        className,
      )}
      {...props}
    >
