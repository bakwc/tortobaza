...
const TONES: Record<CrmOrderStatus, CrmOrderStatusTone> = {
  ...
  ready: {
    ...
    media: "border-yellow-200 bg-white",
    panel: "border-yellow-200/80 bg-white/70",
    panelSoft: "border border-yellow-200/80 bg-white/80",
